  ...
  return (
    <div className='w-[100vw] min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row items-center justify-center gap-4 px-[30px]'>
        <div className='w-[100%] lg:w-[350px] lg:h-[100%] h-[400px]  flex flex-col items-start justify-center gap-1 md:px-[40px]  px-[20px]'>
          ...
          <p className='text-[17px]'>LMS Certifications Pvt. Ltd. is an online learning platform dedicated to delivering high-quality courses, practical training, and industry-recognized certifications to help learners build successful careers.</p>
